...
import 'package:keekz_local_guide/screens/profile/edit_profile_screen.dart';
import 'package:keekz_local_guide/services/auth_services.dart' as auth;
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: auth.AuthService.logout,
          ),
        ],
      ),
      body: FutureBuilder(
