...
import 'package:keekz_local_guide/services/storage_service.dart';
import 'package:provider/provider.dart';

class CreateKeekzScreen extends StatefulWidget {
  @override
  _CreateKeekzScreenState createState() => _CreateKeekzScreenState();
}

class _CreateKeekzScreenState extends State<CreateKeekzScreen> {
  File _image;
